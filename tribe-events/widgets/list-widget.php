	...
	<ol class="tribe-list-widget">
		...
		foreach ( $posts as $post ) :
			...
			<li class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				...
				<!-- Event Title -->
				<div class="event-side-date">
					<a href="<?php echo esc_url( tribe_get_event_link() ); ?>"><?php echo tribe_get_start_date(null, false, 'F j', null ); ?></a>
				</div>
				...
				<?php echo tribe_get_start_date(null, false, 'g:i a', null ); ?>
				</div>
